...
public class CommonVO implements Serializable{
    ...
    private boolean athCheck;
    private boolean wrtCheck;
    ...
    private final String strId = "ST00002";
	...
	public boolean isAthCheck() {
		return athCheck;
	}

	public void setAthCheck(boolean athCheck) {
		this.athCheck = athCheck;
	}

	public boolean isWrtCheck() {
		return wrtCheck;
	}

	public void setWrtCheck(boolean wrtCheck) {
		this.wrtCheck = wrtCheck;
	}
