 ...
 *
 */
public class ImgPaginationAdminRenderer extends AbstractPaginationRenderer implements ServletContextAware{
...
//		firstPageLabel    = "<a href=\"#\" class=\"pre\" onclick=\"{0}({1}); return false;\">" + "처음</a>&#160;";
		...
		currentPageLabel = "<li><a href=\"#\" class=\"a_active\"); return false;\">{0}</a>&#160;</li>";
