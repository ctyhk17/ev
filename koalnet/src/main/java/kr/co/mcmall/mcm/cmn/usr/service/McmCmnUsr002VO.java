...
/**
 * @Class Name : McmCmnUsr001VO.java
 * @Description : McmCmnUsr001VO Class
 *                조합원관리 VO
 ...
 *
 */
public class McmCmnUsr002VO extends CommonVO {
	...
	public String getSearchAthCd() {
		return searchAthCd;
	}
	public void setSearchAthCd(String searchAthCd) {
		this.searchAthCd = searchAthCd;
	}
