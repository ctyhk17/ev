									...
									<td style="text-align:left;">
										<form id="SendPayForm_id" name="" method="POST" >
											...
											<div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
												...
												<br/><input  style="width:100%;" name="gopaymethod" value="DirectBank:HPP:VBank" >
												<br/><br/>

												<br/>
												<b>offerPeriod</b> : 제공기간
												<br/>ex)20151001-20151231, [Y2:년단위결제, M2:월단위결제, yyyyMMdd-yyyyMMdd : 시작일-종료일]
												<br/><input  style="width:100%;" name="offerPeriod" value="20170601-20181231" >
												<br/><br/>
												...
												<br/><input style="width:100%;" name="acceptmethod" value="HPP(2):below1000" >
