...
// 				out.println("<td class='td02'><p>" +resultMap.get("resultMsg")+"</p></td></tr>");	
				...
				if("VBank".equals(resultMap.get("payMethod"))){ //가상계좌
					...
					out.println("<tr><th class='td01'><p>휴대폰번호</p></th>");
					out.println("<td class='td02'><p>" +resultMap.get("KWPY_CellPhone")+"</p></td></tr>");
					out.println("<tr><th class='line' colspan='2'><p></p></th></tr>");
					out.println("<tr><th class='td01'><p>거래금액</p></th>");
					out.println("<td class='td02'><p>" +resultMap.get("KWPY_SalesAmount")+"</p></td></tr>");
					out.println("<tr><th class='line' colspan='2'><p></p></th></tr>");
					out.println("<tr><th class='td01'><p>공급가액</p></th>");
					out.println("<td class='td02'><p>" +resultMap.get("KWPY_Amount")+"</p></td></tr>");
					out.println("<tr><th class='line' colspan='2'><p></p></th></tr>");
					out.println("<tr><th class='td01'><p>부가세</p></th>");
					out.println("<td class='td02'><p>" +resultMap.get("KWPY_Tax")+"</p></td></tr>");
					out.println("<tr><th class='line' colspan='2'><p></p></th></tr>");
					out.println("<tr><th class='td01'><p>봉사료</p></th>");
					out.println("<td class='td02'><p>" +resultMap.get("KWPY_ServiceFee")+"</p></td></tr>");
					out.println("<tr><th class='line' colspan='2'><p></p></th></tr>");
...
// 					out.println("<td class='td02'><p>" +resultMap.get("applPrice")+"원</p></td></tr>");
				...
				}else if("YPAY".equals(resultMap.get("payMethod"))){ //엘로우 페이
					//별도 응답 필드 없음
				...
				}else if("HPMN".equals(resultMap.get("payMethod"))){//빌링결제
