    	...
    	<script type="text/javascript">
			$(document).ready(function(){
				...
				$('#searchBtn').click(function( ){
					...
					$("#ddCmt001VO").attr("action", "<c:url value='/McmCmnBbs006M31L.do'/>");
					$("#ddCmt001VO").submit();	
				});
			...
			function fnUpdate() {
				$("#mcmCmnBbs006VO").attr("action", "<c:url value='/McmCmnBbs006M34U.do'/>");
			...
			function fnDelete() {
		    	...
		    	$.post(
		    		"<c:url value='/McmCmnBbs006M35DP.do'/>",
		    		{	
		    			"bbsId" : bbsId
		    		},
				...
				<div class="aside_back">
					<div class="aside">
						...
						<div class="content">
							...
							<%-- 페이지 네베게이션 시작 --%>
							<div class="aside_menu_back">고객센터 > 고객후기 ><b> 고객후기 조회</b></div>
							<%-- 페이지 네베게이션  끝--%>
							...
							<div class="content_1">
		                        ...
		                        <div class="content_1_top">
		                            <h3>고객후기 <small>| 고객후기을 조회 하실 수 있습니다.</small></h3>
		                        </div>
		                        <%-- 상단 타이틀 끝  --%>
		                                    ...
		                                    <div class="tab_line tab_1_1"> 
			                                       ...
			                                       <%-- ========================================== --%>
			                                        ...
			                                        <div class="resize_box">
			                                            <ul class="re_first" >
			                                                <li class="title_back" style="width:16%;">고객후기</li>
			                                                <li class="sub_back" style="width:64%;"><c:out value="${resultMap.bbsSbj }" /></li>
			                                            </ul>
			                                            <ul>
			                                                <li class="sub_back" style="width:80%;padding:50px 0 50px 20px;">
			                                                	<c:out value="${fn:replace(resultMap.bbsCnts, cn, br)}" escapeXml="false"/>
			                                                </li>
			                                            </ul>
			                                        </div><!-- resize_box -->
			                                       <%-- 하단 버튼 시작 --%>
