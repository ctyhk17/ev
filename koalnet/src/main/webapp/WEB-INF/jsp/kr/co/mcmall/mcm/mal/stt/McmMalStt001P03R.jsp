    ...
    /* =================================================================== End of admin_popup =================================================================== */
	    ...
	    <script type="text/javascript">
				...
				function fnFind(){
					...
					$.post(
							"<c:url value='/McmMalStt001P03RP.do'/>",
							{
								"usrNm":usrNm,
								"telNo":telNo
							},
							function(result){
								innerHTML = "<table><tr style='text-align:center;'><th>아이디</th><th>이름</th><th>연락처</th><th>이메일</th></tr>";
								for(var i=0; i<result.list.length; i++)
								{
									...
									innerHTML += "<tr style='text-align:center;' name='resultList' usrId='"+usrId+"'>"
											  +  "<td>"+usrId+"</td>"
											  +  "<td>"+usrNm2+"</td>"
											  +  "<td>"+telNo2+"</td>"
											  +  "<td>"+emailAddr+"</td>"
				...
				function fnSendToUsrId(){
					var str = $("#usrId").val();
					$("#searchUsrId",opener.document).val(str);
