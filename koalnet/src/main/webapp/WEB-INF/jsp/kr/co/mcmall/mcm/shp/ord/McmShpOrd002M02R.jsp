	    ...
	    <script type="text/javascript">
			...
			$(document).ready(function(){
				...
				$('#btnList').click(function( ){
					...
					$("#mcmShpOrd002VO").attr("action", "<c:url value='/McmShpOrd002M01L.do'/>");
					$("#mcmShpOrd002VO").submit();	
				});
				...
				$('#btnSearch').click(function( ){
					...
					$("#mcmShpOrd002VO").attr("action", "<c:url value='/McmShpOrd002M02R.do'/>");
					$("#mcmShpOrd002VO").submit();	
				});
...
<form:form commandName="mcmShpOrd002VO" name="mcmShpOrd002VO" method="post">
				...
				<div class="aside_back">
					<div class="aside">
			                ...
			                <div class="content">
			                	...
			                	<%-- 페이지 네베게이션 시작 --%>
								<div class="aside_menu_back">주문현황 > 주문조회 ><b>주문현황</b></div>
								<%-- 페이지 네베게이션  끝--%>
								...
								<div class="content_1">
			                        ...
			                        <div class="content_1_top">
			                            <h3>주문현황 <small>| 주문상세조회를 할 수 있습니다.</small></h3>
			                        </div>
			                        <%-- 상단 타이틀 끝  --%>
			                                      ...
			                                      <%-- 검색 결과 시작 --%>
			                                        <div class="resize_box">
			                                           <!-- <h3>1:1상담</h3> -->
                                                		  ...
                                                		  <li class="sub_back" style="width : 40%;">
                                                		  ...
                                                		  <li class="sub_back" style="width : 40%;">
                                               		  	   <form:select path="scGdsId" style="width:70%;">
