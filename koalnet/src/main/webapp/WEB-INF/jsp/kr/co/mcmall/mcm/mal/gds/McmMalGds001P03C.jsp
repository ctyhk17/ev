					...
					$("#McmMalGds001VO").ajaxSubmit({
			        	...
			        	complete : function(result) {
			        		...
			        		var filePath =  result.responseJSON.filePath;
			        		 ...
			        		 $("#gdsImgNm",opener.document).val(finalIndex);
			        		 $("#gdsAttSnImg",opener.document).val(oriFileName);
			        		 $("#gdsAttSnImgPath",opener.document).val(filePath+fileName);
			        		 $("#parentImgBox",opener.document).attr("src",$("#img_box_img").attr("src"));
			        		 window.close();
			        	},
			        	error : function() {
			        		alert('이미지를 선택해주세요');
