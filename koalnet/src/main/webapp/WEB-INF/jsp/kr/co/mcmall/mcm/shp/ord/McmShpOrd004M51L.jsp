	    ...
	    <script type="text/javascript">
			...
			$(document).ready(function(){
				...
				$('#btnSearch').click(function( ){
					...
					$("#mcmShpOrd004VO").attr("action", "<c:url value='/McmShpOrd004M51L.do'/>");
			...
			function infoView(obj){
				obj.css("cursor","pointer").click(function(){
					...
					$("#mcmShpOrd004VO").attr("action", "<c:url value='/McmShpOrd004M52R.do'/>");
					$("#mcmShpOrd004VO").submit();
				});
			};
				...
				<div class="aside_back">
					<div class="aside">
			                ...
			                <div class="content">
			                	...
			                	<%-- 페이지 네베게이션 시작 --%>
								<div class="aside_menu_back">주문관리 > <b>환불관리</b></div>
								<%-- 페이지 네베게이션  끝--%>
								...
								<div class="content_1">
			                        ...
			                        <div class="content_1_top">
			                            <h3>환불관리 <small>| 환불 요청된 주문을 조회 할 수 있습니다.</small></h3>
			                        </div>
			                        <%-- 상단 타이틀 끝  --%>
