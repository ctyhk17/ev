				...
				$(document).ready(function () {
					$("#btnSearch").click(function(){
				     ...
				     function fnSearch(){
							...
							$("#mcmMalStt001VO").attr("action", "<c:url value='/McmMalStt001M01L.do'/>");
				...
				<div class="aside_back">
					<div class="aside">
			                ...
			                <div class="content">
			                	...
			                	<%-- 페이지 네베게이션 시작 --%>
			                    <div class="aside_menu_back">현황통계 > <b>상품별 매출현황</b></div>
			                    <%-- 페이지 네베게이션  끝--%>
			                    ...
			                    <div class="content_1">
			                        ...
			                        <div class="content_1_top">
			                            <h3>상품별 매출현황 <small>| 상품별 매출현황을 조회하실 수 있습니다.</small></h3>
			                        </div>
			                        <%-- 상단 타이틀 끝  --%>
...
<!-- 					                                                    <li style="width:5%;">순번</li> -->
					                                            ...
					                                            <c:forEach var="selectResultListGds" items="${selectResultListGds}">
					                                            <div class="flex flex_2">
					                                                <ul>
<%-- 					                                                    <li style="width:5%;"><c:out value="${selectResultListGds.rn}"/></li> --%>
					                                                    <li style="width:21.39999%;"><c:out value="${selectResultListGds.gdsNm}"/></li>
					                                                    <li style="width:13%;"><c:out value="${selectResultListGds.cntAll}"/></li>
					                                                    <li style="width:13%;"><c:out value="${selectResultListGds.ordTotAmtall}"/></li>
					                                                    <li style="width:13%;"><c:out value="${selectResultListGds.cntOk}"/></li>
					                                                    <li style="width:13%;"><c:out value="${selectResultListGds.ordTotAmtOk}"/></li>
					                                                    <li style="width:13%;"><c:out value="${selectResultListGds.cntNo}"/></li>
					                                                    <li style="width:13%;"><c:out value="${selectResultListGds.ordTotAmtNo}"/></li>
<%-- 					                                                    <li style="width:29%;">http://www.koalnetcity.net/<c:out value="${selectResultListDay.lcsId}"/></li> --%>
					                                                </ul>
					                                            </div>
					                                            </c:forEach>
					                                            
					                                             <c:if test="${empty selectResultListGds}">
					                                            <div class="flex flex_2">
						                                            <ul>
