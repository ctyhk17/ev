	...
	<%@ include file="/WEB-INF/jsp/kr/co/mcmall/mcm/include/McmBrcHeadInclude.jsp" %>
		...
		<script type="text/javascript">
			...
			$(document).ready(function () {  
				...
				//$("#accNo").keyup(function(){$(this).val( $(this).val().replace(/[^0-9]/g,"") );});
			...
			function btnJoin(){
				...
				//$("#accNo").val($("#accNo").val().replace(/[^0-9]/g,""));
				...
				*/
				...
				$("#ddFndOrd001VO").attr("action", "<c:url value='/fnd/ord/DdFndOrd001R121Proc.do'/>");
...
<article>
    <div id="content_box">
        ...
        <div class="sub_content_1">
            ...
            <div class="sub_box_1">
            <h1><img src="<c:url value='/images/dang_logo_1.png' />" alt="" /> 회원가입하기</h1>
            ...
            <div id="sub2_box">
            	<div>
                    ...
                    <%-- <div><span><b>*</b> 은행</span>
                    	<form:select path="bnkCd" >
							<form:option value="">선택해주세요.</form:option>
							<c:forEach var="bnkCode" items="${bnkCodeList}" varStatus="status">
								<form:option value="${bnkCode.cd}">${bnkCode.cdNm}</form:option>
							</c:forEach>
						</form:select>
                    	</div>
                    <div><span><b>*</b> 계좌번호</span><form:input path="accNo"  maxlength="30" /></div>
                    <div><span><b>*</b> 예금주</span><form:input path="dpstNm" maxlength="15" /></div> --%>
				</div>                    
            </div>
            ...
            <div id="sub2_box1">
                ...
                <textarea readonly rows="8" cols="88" style="textarea_scroll-auto; resize:none;margin:15px 0;">
1. 개인정보 수집 및 이용목적
