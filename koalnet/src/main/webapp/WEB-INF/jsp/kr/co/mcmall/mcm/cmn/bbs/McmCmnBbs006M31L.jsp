	    ...
	    <script type="text/javascript">
			...
			$(document).ready(function(){
						...
						$('#btnSearch').click(function( ){
							...
							$("#mcmCmnBbs006VO").attr("action", "<c:url value='/McmCmnBbs006M31L.do'/>");
							$("#mcmCmnBbs006VO").submit();	
						});
						
						$('#btnWrite').click(function(){
				    		location.href="<c:url value='/McmCmnBbs006M33C.do'/>?upMenuId=M003&subMenuId=M003004"
				    	});
					...
					function infoView(obj){
						obj.css("cursor","pointer").click(function(){
							...
							$("#mcmCmnBbs006VO").attr("action", "<c:url value='/McmCmnBbs006M32R.do'/>");
							$("#mcmCmnBbs006VO").submit();
						});
					};
			                ...
			                <div class="content">
								...
								<div class="content_1">
			                        ...
			                        <div class="content_1_top">
			                            <h3>고객후기 <small>| 고객후기을 조회하실 수 있습니다.</small></h3>
			                        </div>
			                        <%-- 상단 타이틀 끝  --%>       
			                                    ...
			                                    <div class="tab_line tab_1_1"> 
			                                      ...
			                                      <%-- 검색 결과 시작 --%>
			                                        <div class="resize_box">
		                                                <ul class="re_first">			                                            
			                                              <li class="title_back"style="width:15%;">고객후기</li>
				                                        ...
				                                        <div class="suchen_result"> 전체 <b><c:out value="${totCnt }" /></b></b>건</div>
					                                        <div>
					                                            <div class="flex first_flex">
					                                                <ul>
					                                                    <li style="width:9.69999%;">번호</li>
					                                                    <li style="width:60%;">고객후기</li>
					                                            ...
					                                            <div class="flex flex_2" >
					                                                <ul name="resultList"  bbsId = "${resultMap.bbsId }" usrId = "${resultMap.usrId }">
					                                                    <li style="width:9.69999%;"><c:out value="${resultMap.rn }" /></li>
					                                                    <li style="width:60%; text-align: left;"><c:out value="${resultMap.bbsSbj }" /></li>
