    	...
    	<script type="text/javascript">
			...
			function fnWrite(){
		    	...
		    	if( bbsCnts == '' )  {
	 	    	...
	 	    	$.post(
	 	    		"<c:url value='/McmCmnBbs006M33CP.do'/>",
	 	    		{
	 	    			"bbsSbj" : bbsSubJect,
	 	    			"bbsCnts" : bbsCnts,
	 	    			"bbsId" : $("#bbsId").val(),
				...
				<div class="aside_back">
					<div class="aside">
						...
						<div class="content">
							...
							<%-- 페이지 네베게이션 시작 --%>
							<div class="aside_menu_back">고객센터 > 고객후기 > <b>고객후기 입력</b></div>
							<%-- 페이지 네베게이션  끝--%>
							...
							<div class="content_1">
		                        ...
		                        <div class="content_1_top">
		                            <h3>고객후기 <small>| 고객후기을 입력하실 수 있습니다.</small></h3>
		                        </div>
		                        <%-- 상단 타이틀 끝  --%>
			                                        ...
			                                        <div class="resize_box">
			                                            ...
			                                            <ul>
			                                                ...
			                                                <li class="sub_back" style="width:50%;">
			                                                	<textarea rows="10" cols="70" id="bbsCnts" name="bbsCnts" ></textarea>
			                                                </li>
			                                            </ul>
