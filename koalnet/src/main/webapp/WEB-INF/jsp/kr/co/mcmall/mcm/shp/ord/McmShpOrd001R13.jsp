...
<input type="hidden" name="returnUrl"    value="${ returnDomain }/INIStdPayWebReturn.do" />
        ...
        <div class="sub_content_1">
           ...
           <div id="sub3_content">
                <div>
                    ...
                    <div class="sub3_con_title">
                     <h1>구매가 완료되었습니다.</h1>
                      ...
                      <p><b>결제금액 : <fmt:formatNumber value="${resultInfo.payAmt}" groupingUsed="true"/> 원</b></p>
                      <br>
            ...
            <div class="sub_box_2_2" id="sub_box_bu">
            	...
            	<a href="<c:url value='/cmn/itr/DdCmnItr999R.do' />"class="ti"><h2>쇼핑몰로 이동</h2></a>
            </div>   
