	...
	<%@ include file="/WEB-INF/jsp/kr/co/mcmall/mcm/include/McmBrcHeadInclude.jsp" %>
		...
		<script type="text/javascript">
			...
			function btnLogin(){
				...
				$("#ddFndOrd001VO").attr("action", "<c:url value='/fnd/ord/DdFndOrd001R22Proc.do'/>");
			...
			function btnGoJoin(){
				...
				$("#ddFndOrd001VO").attr("action", "<c:url value='/fnd/ord/DdFndOrd001R221.do'/>");
				$("#ddFndOrd001VO").submit();
			}
...
<article>
	...
	<div id="content_box">
        ...
        <div class="sub_content_1">
            ...
            <div class="sub_box_1">
            <h1><img src="<c:url value='/images/Mv.png' />" alt="" /> 로그인/신규 회원가입</h1>
            ...
            <div id="main_box">
                ...
                <%-- <div>
                   <div class="line_main line_main_bottom"></div>
                    <div><span><b></b> 아이디</span><form:input path="usrId" /><a href="#;" class="login_main" id="btnLogin">로그인</a></div>
